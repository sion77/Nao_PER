...
AppWizard a créé cette DLL SERVICES_UNMANAGED pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application SERVICES_UNMANAGED.


SERVICES_UNMANAGED.vcxproj
...
SERVICES_UNMANAGED.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé SERVICES_UNMANAGED.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
